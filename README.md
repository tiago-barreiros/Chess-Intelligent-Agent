...
> The first practical project regards the implementation of an “Intelligent Agent”, in Python
language, able to play Chess against an opponent, in a server-client framework.

> As illustrated below, the framework is composed of a “Server” (supplied by the Teacher),
where two “Client” applications should connect to.
...
[![Python][Python]][Python-url] [![JetBrains][JetBrains]][JetBrains-url] [![LaTeX][LaTeX]][LaTeX-url] [![Overleaf][Overleaf]][Overleaf-url]
...
Após a entrega deste projeto ficará público :  https://github.com/Chess-Intelligent-Agent
...
## [Prof. Doutor Hugo Proença](https://www.di.ubi.pt/~hugomcp/)

## *Inteligência Artificial* @[Universidade da Beira Interior](https://www.ubi.pt/).
